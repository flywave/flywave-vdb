...
protected:
  ...
  static inline unsigned int BoxClipCode(const ScalarType * offsets, const CoordType & p)
  {
    ...
    code |= ((( p[0] - offsets[0]) > eps) ? 0: (1 << 0));
    code |= (((-p[0] - offsets[1]) > eps) ? 0: (1 << 1));
    code |= ((( p[1] - offsets[2]) > eps) ? 0: (1 << 2));
    code |= (((-p[1] - offsets[3]) > eps) ? 0: (1 << 3));
    code |= ((( p[2] - offsets[4]) > eps) ? 0: (1 << 4));
    code |= (((-p[2] - offsets[5]) > eps) ? 0: (1 << 5));
