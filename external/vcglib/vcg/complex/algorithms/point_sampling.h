...
void
_random_shuffle(_RandomAccessIterator __first, _RandomAccessIterator __last,
...
static void	FillAndShuffleFacePointerVector(MeshType & m, std::vector<FacePointer> &faceVec)
{
    ...
    _random_shuffle(faceVec.begin(),faceVec.end(), p_myrandom);
}
static void	FillAndShuffleVertexPointerVector(MeshType & m, std::vector<VertexPointer> &vertVec)
{
    ...
    unsigned int (*p_myrandom)(unsigned int) = RandomInt;
    _random_shuffle(vertVec.begin(),vertVec.end(), p_myrandom);
}
                               ...
                               ScalarType diskRadius, PoissonDiskParam &pp)
{
  ...
  int t0 = clock();
    ...
    unsigned int (*p_myrandom)(unsigned int) = RandomInt;
    _random_shuffle(montecarloSHT.AllocatedCells.begin(),montecarloSHT.AllocatedCells.end(), p_myrandom);
    int t1 = clock();
