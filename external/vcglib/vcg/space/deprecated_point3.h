...
public:
    ...
    enum {Dimension = 3};
    template <class OScalarType> friend class Point3;
...
//@{
  ...
  inline Point3 () { }
    ...
    template <class OScalarType>
    inline Point3 & operator =(Point3<OScalarType> const & p)
    {
      _v[0] = static_cast<P3ScalarType>(p._v[0]); _v[1] = static_cast<P3ScalarType>(p._v[1]); _v[2] = static_cast<P3ScalarType>(p._v[2]);
      return *this;
    }
    inline void SetZero()
    {
