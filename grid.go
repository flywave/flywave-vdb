...
// #cgo CFLAGS: -I ./lib
// #cgo CXXFLAGS: -I ./lib
// #cgo linux LDFLAGS:  -L ./lib -L /usr/lib/x86_64-linux-gnu -Wl,--start-group  -lstdc++ -lm -pthread -ldl -lamd -lamd_l -lbin_packer -lblosc -lboost_chrono -lboost_date_time -lboost_filesystem -lboost_iostreams -lboost_program_options -lboost_serialization -lboost_thread -lboost_atomic -lboost_container -lboost_random -lboost_timer -lcamd -lcamd_l -lccolamd -lccolamd_l -lceres -lcholmod -lcholmod_l -lcolamd -lcolamd_l -lembree -lembree_sse42 -lembree_avx -lembree_avx2 -lmath -ltasking -llexers -lsimd -lsys -lexpat -lfmt -lfontconfig -lfreetype -lGKlib -liconv -licudata -licudt -licui18n -licutools -licuuc -lOpenEXR -lOpenEXRCore -lOpenEXRUtil -lIlmThread -lIex -lImath -lopenjph -ljasper -ljpeg -llerc -llexers -llz4 -llzma -lmetis -lOpenImageIO -lOpenImageIO_Util -lopenvdb -lpng -lsimd -lsnappy -lspqr -lSuiteSparse_config -lsys -ltbb -ltiff -lvdb -lwebp -lxatlas -lxml2 -lzlib -lzstd -ltungsten -ltungsten_thirdparty -ldenoiser -Wl,--end-group
// #cgo windows LDFLAGS: -L ./lib　-lamd -lamd_l -lbin_packer -lblosc -lboost_chrono -lboost_date_time -lboost_filesystem -lboost_iostreams -lboost_program_options -lboost_serialization -lboost_thread -lboost_atomic -lboost_container -lboost_random -lboost_timer -lcamd -lcamd_l -lccolamd -lccolamd_l -lceres -lcholmod -lcholmod_l -lcolamd -lcolamd_l -lembree -lembree_sse42 -lembree_avx -lembree_avx2 -lmath -ltasking -llexers -lsimd -lsys -lexpat -lfmt -lfontconfig -lfreetype -lGKlib -liconv -licudata -licudt -licui18n -licutools -licuuc -lOpenEXR -lOpenEXRCore -lOpenEXRUtil -lIlmThread -lIex -lImath -lopenjph -ljasper -ljpeg -llerc -llexers -llz4 -llzma -lmetis -lOpenImageIO -lOpenImageIO_Util -lopenvdb -lpng -lsimd -lsnappy -lspqr -lSuiteSparse_config -lsys -ltbb -ltiff -lvdb -lwebp -lxatlas -lxml2 -lzlib -lzstd -ltungsten -ltungsten_thirdparty -ldenoiser
