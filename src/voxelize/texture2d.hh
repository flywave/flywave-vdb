...
struct color_value_type<vdb::math::Vec2<T>, S> {
  typedef T pixel_type;
  typedef vdb::math::Vec2<T> type;
  typedef vdb::math::Vec2<S> vector_type;
};

template <typename T, typename S>
struct color_value_type<vdb::math::Vec3<T>, S> {
  typedef T pixel_type;
  typedef vdb::math::Vec3<T> type;
  typedef vdb::math::Vec3<S> vector_type;
};

template <typename T, typename S>
struct color_value_type<vdb::math::Vec4<T>, S> {
  typedef T pixel_type;
  typedef vdb::math::Vec4<T> type;
  typedef vdb::math::Vec4<S> vector_type;
};
